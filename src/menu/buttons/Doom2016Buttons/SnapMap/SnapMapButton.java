package menu.buttons.Doom2016Buttons.SnapMap;
...
public class SnapMapButton extends Button {
    public SnapMapButton(int x, int y, String text, int width, int height, String imagePath, String imagePath2, String moviePath, String fontPath, double fontSize, Color textColor, Color textColor2, Pos alignment) {
    ...
    public void mouseEnter() {
        ...
        Main.removeWindows(StaticButtons.startMultiPlayer.stackPane(), StaticButtons.rankingsMultiplayer.stackPane(), StaticButtons.achievnementMultiButton.stackPane(), StaticButtons.seeMore.stackPane(), StaticButtons.seeMore2.stackPane(), StaticButtons.startCampaignButton.stackPane());
        Main.addWindowsIfNotExist(StaticButtons.createSnapMap.stackPane(), StaticButtons.loadSnapMap.stackPane(), StaticButtons.seeBestMap.stackPane());
    }
